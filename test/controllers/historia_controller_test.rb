...
class HistoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create historium" do
    assert_difference('Historium.count') do
      post historia_url, params: { historium: { narracion: @historium.narracion, titulo: @historium.titulo } }
    end
  ...
  test "should update historium" do
    patch historium_url(@historium), params: { historium: { narracion: @historium.narracion, titulo: @historium.titulo } }
