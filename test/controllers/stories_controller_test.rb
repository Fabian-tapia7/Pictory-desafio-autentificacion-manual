...
class StoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create story" do
    assert_difference('Story.count') do
      post stories_url, params: { story: { narracion: @story.narracion, titulo: @story.titulo } }
    end
  ...
  test "should update story" do
    patch story_url(@story), params: { story: { narracion: @story.narracion, titulo: @story.titulo } }
